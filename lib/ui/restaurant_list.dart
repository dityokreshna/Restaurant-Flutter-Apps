...
class _RestaurantUiListState extends State<RestaurantUiList> {
                ...
                : _selectedIndex == 1
                    ? CustomScrollView(slivers: [
                        makeHeader(context, "Favorite",
                            "(Long Press to Delete Favorite Restaurant)"),
                        ...
                        builder: (context, state, _) {
                          if (state.state == ResultState.Loading) {
                            ...
                            return _listItem(
                                ...
                                state.result,
                                "Restaurant",
                                "(Long Press to Add Favorite Restaurant)");
  ...
  showAlertDialog(BuildContext context, bool isDelete, Function() pressButton) {
    // set up the buttons
    ...
    AlertDialog alert = AlertDialog(
      title: Text(isDelete ? "Delete Item" : "Add Favorite"),
      content: Text(isDelete
          ? "Are you sure to delete this restaurant from your favorite list?"
          : "Are you sure to add this restaurant to your favorite list?"),
      actions: [
        cancelButton,
        continueButton,
      ],
