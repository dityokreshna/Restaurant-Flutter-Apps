...
//
//     final restaurantDataDetail = restaurantDataDetailFromMap(jsonString);
...
class RestaurantDataDetail {
    ...
    bool error;
    String message;
    RestaurantDataDetailElement restaurant;

    factory RestaurantDataDetail.fromJson(String str) => RestaurantDataDetail.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory RestaurantDataDetail.fromMap(Map<String, dynamic> json) => RestaurantDataDetail(
        error: json["error"],
        message: json["message"],
        restaurant: RestaurantDataDetailElement.fromMap(json["restaurant"]),
    );
...
class RestaurantDataDetailElement {
    RestaurantDataDetailElement({
        required this.id,
        required this.name,
    ...
    factory RestaurantDataDetailElement.fromJson(String str) => RestaurantDataDetailElement.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory RestaurantDataDetailElement.fromMap(Map<String, dynamic> json) => RestaurantDataDetailElement(
        id: json["id"],
        name: json["name"],
